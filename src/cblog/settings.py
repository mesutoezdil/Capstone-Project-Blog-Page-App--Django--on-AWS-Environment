...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cser7e6zou1m.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstones-satoshi-blog' # please enter your s3 bucket name
